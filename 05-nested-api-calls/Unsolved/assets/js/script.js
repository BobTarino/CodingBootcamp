function myFunction() {
  fetch(
    ...
    .then(function(wikiResponse) {
      ...
      // YOUR CODE HERE
      var responseEl = document.getElementById('response-header');
      responseEl.innerHTML = '<h2>' + searchTerm + '</h2>';
      ...
      // YOUR CODE HERE
      return fetch(
        'https://api.giphy.com/v1/gifs/search?q=' + searchTerm + '&rating=' + rating + '&api_key=HvaacROi9w5oQCDYHSIk42eiDSIXH3FN&limit=1'
      );
